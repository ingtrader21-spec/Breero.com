...
APPROVED_CONTROL_PLANE_WORKFLOW_SHA256: dict[str, dict[str, str]] = {
    ...
    "ingtrader21-spec/Breero.com": {
        ...
        ".github/workflows/deployment-preflight.yml": "a8d1de6a5344ac68e181d3da5340348781e4c0be261f41c4f1a7c9c85c05bf58",
    },
    "appolon1908-hue/Moneybee-Backend": {
...
APPROVED_READ_ONLY_SCRIPT_INVOCATIONS: dict[
    ...
    "ingtrader21-spec/Breero.com": {
        "scripts/deploy/test-runtime-path-verifier.sh": (
            "11bd239f35f4f916ec877a283dbdc4dc85324f35b60ede601c0549dd9209424a",
            frozenset({()}),
        ),
        "scripts/deploy/test-security-validators.py": (
            "2de94df677e67a16d2da11381c876491f26d3ee3111c0eaa8e6376d1e6f82f5e",
            frozenset({()}),
        ),
        "scripts/ci/test-classify-quality-scope.sh": (
            "ae22198e1547eb1edd44318d57a7a1eb3d6e51a869c4a99fbc819355b86a99c1",
            frozenset({()}),
        ),
    },
    "appolon1908-hue/Keycloak": {
